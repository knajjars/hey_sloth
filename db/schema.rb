...
ActiveRecord::Schema.define(version: 20_210_130_170_811) do
  ...
  create_table 'fire_links', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.string 'slug'
    t.index ['slug'], name: 'index_fire_links_on_slug', unique: true
    t.index ['user_id'], name: 'index_fire_links_on_user_id'
  end
  ...
  create_table 'testimonials', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['fire_link_id'], name: 'index_testimonials_on_fire_link_id'
  ...
  add_foreign_key 'fire_links', 'users'
  add_foreign_key 'testimonials', 'fire_links'
