...
Testimonial.create! name: 'Margie Simpson', role: 'House wife', social_link: 'https://www.twitter.com/margie',
                    user: user, content: 'I am not sure.', fire_link: sl1
Testimonial.create! name: 'Bart Simpson', social_link: 'https://www.twitter.com/bart', user: user,
                    content: 'Ookaaay, I think I like it.', fire_link: sl1
